...
/// 画面へ「状態が変わった」と知らせる。
///
/// 上流の <c>IPCServer.notifyClient</c> / <c>SocketIOManageModel</c> にあたる。呼ぶ場所は
...
{
    /// <summary>上流の <c>updateStatus</c>。200ms 分の呼び出しは 1 本にまとめられる。</summary>
    void NotifyClient();

    /// <summary>上流の <c>updateEncode</c>。エンコードの進捗が動いたとき。</summary>
