...
{
    /// <summary>
    /// The message EPGStation raises when a rule to update no longer exists (enable/disable/delete
    /// do not check existence upstream, only update does).
    /// </summary>
    public const string MissingRuleError = "RuleIsNotFound";
