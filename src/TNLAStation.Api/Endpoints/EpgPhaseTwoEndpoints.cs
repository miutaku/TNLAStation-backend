...
internal static class EpgPhaseTwoEndpoints
{
    public static IEndpointRouteBuilder MapEpgPhaseTwoEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        api.MapGet("/channels/{channelId}/logo", GetChannelLogoAsync)
        ...
        api.MapGet("/schedules/detail/{programId}", GetScheduleDetailAsync)
        ...
        api.MapGet("/schedules/{channelId}", GetChannelSchedulesAsync)
