...
[Migration("20260720000000_InitialEpg")]
public sealed class InitialEpg : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("pk_channels", row => row.id);
                table.UniqueConstraint(
                    "ak_channels_identity",
                    row => new { row.id, row.network_id, row.service_id });
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("pk_epg_sync_state", row => row.singleton_id);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("pk_programs", row => row.id);
                ...
                table.ForeignKey(
                    ...
                    columns: row => new { row.channel_id, row.network_id, row.service_id },
        ...
        migrationBuilder.InsertData(
            table: "epg_sync_state",
            columns: new[] { "singleton_id", "generation", "needs_full_sync" },
            values: new object[] { (short)1, 0L, true });
    ...
    {
        migrationBuilder.DropTable(name: "epg_sync_state");
